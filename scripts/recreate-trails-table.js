...
const dbConfig = {
  client: 'pg',
  connection: {
    connectionString: 'postgresql://neondb_owner:npg_VdrkBMsfI35z@ep-frosty-mud-a924gwbk-pooler.gwc.azure.neon.tech/neondb?sslmode=require&channel_binding=require',
