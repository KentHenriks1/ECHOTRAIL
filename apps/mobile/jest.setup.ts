...
process.env.GOOGLE_MAPS_API_KEY =
  process.env.GOOGLE_MAPS_API_KEY || "AIzaSyAs52yi4Aa4XsCDUGKlUciooSqsFdXL5Ms";
process.env.OPENAI_API_KEY =
  process.env.OPENAI_API_KEY ||
  "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";
process.env.MAPBOX_ACCESS_TOKEN =
  process.env.MAPBOX_ACCESS_TOKEN ||
  "sk.eyJ1Ijoia2VudGhlbnJpa3MxIiwiYSI6ImNtZmgyZWFzMDA2MmQyanM0bjVnYnZobnAifQ.DZJvMeZ5zILXTypOKssU0g";
process.env.STACK_AUTH_JWKS_URL =
  process.env.STACK_AUTH_JWKS_URL ||
  "https://api.stack-auth.com/api/v1/projects/db2ad2a3-87d0-46de-afa8-61eb681fcdea/.well-known/jwks.json";
